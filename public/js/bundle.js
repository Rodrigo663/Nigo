...
},{"process":"../../node_modules/process/browser.js"}],"circle.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendCircle = void 0;

var _jquery = _interopRequireDefault(require("jquery"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var sendCircle = function sendCircle() {
  var button = (0, _jquery.default)("#main-svg");
  var flex = (0, _jquery.default)(".bike__flex");
  var use = (0, _jquery.default)("#use");
  var main = (0, _jquery.default)(".bike__main");
  ...
  var navbar = (0, _jquery.default)(".right-bar");
  var content = (0, _jquery.default)(".right-bar__content");
};

exports.sendCircle = sendCircle;
},{"jquery":"../../node_modules/jquery/dist/jquery.js"}],"body.js":[function(require,module,exports) {
"use strict";
...
var sendFunc = function sendFunc() {
  (0, _jquery.default)("body").on("click", function (e) {
    if (e.target.id == "myDiv" || (0, _jquery.default)(e.target).parents("#myDiv").length) {
      console.log('');
    } else {
      ...
      if (hash != "") {
        ...
        console.log(''); // Clear the hash in the URL
